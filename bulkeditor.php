...
function foxyshop_cfbe_metabox($post_type) {
	...
	<table class="widefat cfbe_table cfbe_foxyshop_table">
		<thead>
			<tr>
				<th><img src="<?php echo esc_url(FOXYSHOP_DIR . '/images/icon.png'); ?>" alt="" /><?php echo wp_kses(sprintf(__('Set Values For Checked FoxyShop %s'), FOXYSHOP_PRODUCT_NAME_PLURAL)); ?></th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				<td>
					...
					<label for="_category_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_category_status" id="_category_status1" value="1" />
					<label for="_category_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_saleprice_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_salestartdate_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_salestartdate_status" id="_salestartdate_status1" value="1" />
					<label for="_salestartdate_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_saleenddate_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_saleenddate_status" id="_saleenddate_status1" value="1" />
					<label for="_saleenddate_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_price_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_price_status" id="_price_status1" value="1" />
					<label for="_price_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_weight_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_weight_status" id="_weight_status1" value="1" />
					<label for="_weight_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_quantity_min_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_quantity_min_status" id="_quantity_min_status1" value="1" />
					<label for="_quantity_min_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_quantity_max_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_quantity_max_status" id="_quantity_max_status1" value="1" />
					<label for="_quantity_max_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_quantity_hide_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
			...
			<tr>
				<td>
					...
					<label for="_hide_product_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
			...
			<tr>
				<td>
					...
					<label for="_discount_quantity_amount_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_discount_quantity_amount_status" id="_discount_quantity_amount_status1" value="1" />
					<label for="_discount_quantity_amount_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_discount_quantity_percentage_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_discount_quantity_percentage_status" id="_discount_quantity_percentage_status1" value="1" />
					<label for="_discount_quantity_percentage_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_discount_price_amount_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_discount_price_amount_status" id="_discount_price_amount_status1" value="1" />
					<label for="_discount_price_amount_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_discount_price_percentage_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_discount_price_percentage_status" id="_discount_price_percentage_status1" value="1" />
					<label for="_discount_price_percentage_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_sub_frequency_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_sub_frequency_status" id="_sub_frequency_status1" value="1" />
					<label for="_sub_frequency_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_sub_startdate_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_sub_startdate_status" id="_sub_startdate_status1" value="1" />
					<label for="_sub_startdate_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_sub_enddate_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_sub_enddate_status" id="_sub_enddate_status1" value="1" />
					<label for="_sub_enddate_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			if ($foxyshop_settings['google_product_support']) :
				foreach ($google_product_field_names as $field) {
					...
					<tr>
						<td>
							<label for="_<?php echo esc_attr($field); ?>" class="cfbe_special_label"><?php echo wp_kses($display_title); ?></label>
							<input type="radio" name="_<?php echo esc_attr($field); ?>_status" id="_<?php echo esc_attr($field); ?>_status0" value="0" checked="checked" />
							<label for="_<?php echo esc_attr($field); ?>_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
							<input type="radio" name="_<?php echo esc_attr($field); ?>_status" id="_<?php echo esc_attr($field); ?>_status1" value="1" />
							<label for="_<?php echo esc_attr($field); ?>_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_related_products_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_related_products_status" id="_related_products_status1" value="1" />
					<label for="_related_products_status1"><?php echo wp_kses($change_to_text); ?>:</label>
					<select name="_related_products_list[]" id="_related_products_list" data-placeholder="Search for <?php echo FOXYSHOP_PRODUCT_NAME_PLURAL; ?>" style="width: 100%;" class="chzn-select" multiple="multiple">
						<?php echo wp_kses($all_product_list); ?>
					</select>
					<div style="clear: both;"></div>
				</td>
			</tr>
			...
			<tr>
				<td>
					...
					<label for="_bundled_products_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_bundled_products_status" id="_bundled_products_status1" value="1" />
					<label for="_bundled_products_status1"><?php echo wp_kses($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_addon_products_status0" class="cfbe_leave_unchanged"><?php echo wp_kses($leave_unchanged_text); ?></label>
					<input type="radio" name="_addon_products_status" id="_addon_products_status1" value="1" />
					<label for="_addon_products_status1"><?php echo wp_kses($change_to_text); ?>:</label>
